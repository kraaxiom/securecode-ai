# Remédiation — SSRF ciblant Elasticsearch
...
## Note spécifique — Elasticsearch
Ne jamais laisser l'utilisateur contrôler l'hôte/port du cluster de recherche. Activer l'authentification et le contrôle d'accès sur l'API Elasticsearch même en réseau interne (Security features / X-Pack ou équivalent), et restreindre l'accès réseau au cluster au seul service applicatif légitime.
