# Remédiation — Local File Inclusion (LFI)
...
- [ ] `allow_url_include` est désactivé dans la configuration PHP.
- [ ] Aucune fonction d'inclusion dynamique (`include`/`require`) ne reçoit une valeur non filtrée par une whitelist stricte.
