// Corrigé : Utilisation de MD5 — CWE-328 (Use of Weak Hash)
// Le hachage de mot de passe utilise désormais Argon2id, avec sel automatique et
// coût mémoire/temps adaptatif, conformément à la pile crypto standard du projet.
